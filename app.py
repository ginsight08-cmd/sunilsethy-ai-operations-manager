...
<style>
    ...
    .auth-shell {{ max-width: 900px; margin: 0 auto; }}
    .auth-heading {{ text-align:center; color:#071A3D; font-size:1.8rem; font-weight:800; margin:.2rem 0 .25rem; }}
    .auth-description {{ text-align:center; color:#667085; margin-bottom:1.1rem; }}
    .auth-note {{ text-align:center; color:#667085; font-size:.82rem; margin-top:.8rem; }}
    .auth-card {{ background:#FFFFFF; border:1px solid #E1EAF6; border-radius:20px; padding:.35rem .5rem .8rem; box-shadow:0 12px 35px rgba(7,87,184,.07); }}
